...
/**
 * <p>Java class for ChksumInqRq_Type complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="ChksumInqRq_Type"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "ChksumInqRq_Type", propOrder = {
    "rqUID",
    "msgRqHdr",
    "docCtrlIn",
    "recCtrlIn",
    "chksumSelOrRecSelect"
})
public class ChksumInqRqType {
    ...
    @XmlElements({
        @XmlElement(name = "ChksumSel", type = ChksumSelType.class),
        @XmlElement(name = "RecSelect", type = String.class)
    })
    protected List<Object> chksumSelOrRecSelect;
    ...
    /**
     * Gets the value of the chksumSelOrRecSelect property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the chksumSelOrRecSelect property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getChksumSelOrRecSelect().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<Object> getChksumSelOrRecSelect() {
        if (chksumSelOrRecSelect == null) {
            chksumSelOrRecSelect = new ArrayList<Object>();
        }
        return this.chksumSelOrRecSelect;
    }
