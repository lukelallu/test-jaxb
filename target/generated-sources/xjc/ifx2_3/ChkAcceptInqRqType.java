...
/**
 * <p>Java class for ChkAcceptInqRq_Type complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="ChkAcceptInqRq_Type"&gt;
 *   &lt;complexContent&gt;
 ...
 *           &lt;element ref="{IFX2_3}ChkAcceptSel"/&gt;
...
@XmlType(name = "ChkAcceptInqRq_Type", propOrder = {
    "rqUID",
    "msgRqHdr",
    "docCtrlIn",
    "recCtrlIn",
    "chkAcceptSelOrRecSelect"
})
public class ChkAcceptInqRqType {
    ...
    @XmlElements({
        @XmlElement(name = "ChkAcceptSel", type = ChkAcceptSelType.class),
        @XmlElement(name = "RecSelect", type = String.class)
    })
    protected List<Object> chkAcceptSelOrRecSelect;
    ...
    /**
     * Gets the value of the chkAcceptSelOrRecSelect property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the chkAcceptSelOrRecSelect property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getChkAcceptSelOrRecSelect().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link ChkAcceptSelType }
     * {@link String }
     * 
     * 
     */
    public List<Object> getChkAcceptSelOrRecSelect() {
        if (chkAcceptSelOrRecSelect == null) {
            chkAcceptSelOrRecSelect = new ArrayList<Object>();
        }
        return this.chkAcceptSelOrRecSelect;
    }
