...
/**
 * <p>Java class for CreditInqRq_Type complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="CreditInqRq_Type"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "CreditInqRq_Type", propOrder = {
    "rqUID",
    "msgRqHdr",
    "docCtrlIn",
    "recCtrlIn",
    "creditSelOrRecSelect"
})
public class CreditInqRqType {
    ...
    @XmlElements({
        @XmlElement(name = "CreditSel", type = CreditSelType.class),
        @XmlElement(name = "RecSelect", type = String.class)
    })
    protected List<Object> creditSelOrRecSelect;
    ...
    /**
     * Gets the value of the creditSelOrRecSelect property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the creditSelOrRecSelect property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getCreditSelOrRecSelect().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<Object> getCreditSelOrRecSelect() {
        if (creditSelOrRecSelect == null) {
            creditSelOrRecSelect = new ArrayList<Object>();
        }
        return this.creditSelOrRecSelect;
    }
