...
/**
 * <p>Java class for CardSyncRs_Type complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="CardSyncRs_Type"&gt;
 *   &lt;complexContent&gt;
 ...
 *           &lt;element ref="{IFX2_3}CardRsMsg" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;/sequence&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
...
@XmlType(name = "CardSyncRs_Type", propOrder = {
    "status",
    "rqUID",
    "msgRsHdr",
    "recCtrlOut",
...
public class CardSyncRsType {
    ...
    @XmlElement(name = "CardRsMsg")
    protected List<CardRsMsgType> cardRsMsg;
    ...
    /**
     * Gets the value of the cardRsMsg property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the cardRsMsg property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getCardRsMsg().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<CardRsMsgType> getCardRsMsg() {
        if (cardRsMsg == null) {
            cardRsMsg = new ArrayList<CardRsMsgType>();
        }
        return this.cardRsMsg;
    }
