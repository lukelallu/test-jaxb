...
/**
 * <p>Java class for ProdIntRateInqRs_Type complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="ProdIntRateInqRs_Type"&gt;
 *   &lt;complexContent&gt;
 ...
 *           &lt;element ref="{IFX2_3}ProdIntRateRec" maxOccurs="unbounded"/&gt;
 *         &lt;/sequence&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
...
@XmlType(name = "ProdIntRateInqRs_Type", propOrder = {
    "status",
    "rqUID",
    "msgRsHdr",
    "docCtrlOut",
...
public class ProdIntRateInqRsType {
    ...
    protected List<ProdIntRateRecType> prodIntRateRec;
     ...
     * This is why there is not a <CODE>set</CODE> method for the prodIntRateRec property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getProdIntRateRec().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<ProdIntRateRecType> getProdIntRateRec() {
        if (prodIntRateRec == null) {
            prodIntRateRec = new ArrayList<ProdIntRateRecType>();
        }
        return this.prodIntRateRec;
    }
