...
public class PmtInqRqType {
    ...
    @XmlElements({
        @XmlElement(name = "PmtSel", type = PmtSelType.class),
        @XmlElement(name = "RecSelect", type = String.class)
    })
    protected List<Object> pmtSelOrRecSelect;
    ...
    /**
     * Gets the value of the pmtSelOrRecSelect property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the pmtSelOrRecSelect property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getPmtSelOrRecSelect().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<Object> getPmtSelOrRecSelect() {
        if (pmtSelOrRecSelect == null) {
            pmtSelOrRecSelect = new ArrayList<Object>();
        }
        return this.pmtSelOrRecSelect;
    }
