...
/**
 * <p>Java class for CardAuthInqRq_Type complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="CardAuthInqRq_Type"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "CardAuthInqRq_Type", propOrder = {
    "rqUID",
    "msgRqHdr",
    "docCtrlIn",
    "recCtrlIn",
...
public class CardAuthInqRqType {
    ...
    @XmlElements({
        @XmlElement(name = "CardSel", type = CardSelType.class),
        @XmlElement(name = "RecSelect", type = String.class)
    })
    protected List<Object> cardSelOrRecSelect;
    ...
    /**
     * Gets the value of the cardSelOrRecSelect property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the cardSelOrRecSelect property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getCardSelOrRecSelect().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<Object> getCardSelOrRecSelect() {
        if (cardSelOrRecSelect == null) {
            cardSelOrRecSelect = new ArrayList<Object>();
        }
        return this.cardSelOrRecSelect;
    }
