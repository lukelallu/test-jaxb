...
/**
 * <p>Java class for AcctTrnInqRq_Type complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="AcctTrnInqRq_Type"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "AcctTrnInqRq_Type", propOrder = {
    "rqUID",
    "msgRqHdr",
    "docCtrlIn",
    "recCtrlIn",
    "acctTrnSelOrRecSelect"
})
public class AcctTrnInqRqType {
    ...
    @XmlElements({
        @XmlElement(name = "AcctTrnSel", type = AcctTrnSelType.class),
        @XmlElement(name = "RecSelect", type = String.class)
    })
    protected List<Object> acctTrnSelOrRecSelect;
    ...
    /**
     * Gets the value of the acctTrnSelOrRecSelect property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the acctTrnSelOrRecSelect property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getAcctTrnSelOrRecSelect().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<Object> getAcctTrnSelOrRecSelect() {
        if (acctTrnSelOrRecSelect == null) {
            acctTrnSelOrRecSelect = new ArrayList<Object>();
        }
        return this.acctTrnSelOrRecSelect;
    }
