...
/**
 * <p>Java class for CreditSyncRq_Type complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="CreditSyncRq_Type"&gt;
 *   &lt;complexContent&gt;
 ...
 *         &lt;element ref="{IFX2_3}CreditKeys" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "CreditSyncRq_Type", propOrder = {
    "rqUID",
    "msgRqHdr",
    "recCtrlIn",
    "creditKeys"
})
public class CreditSyncRqType {
    ...
    protected List<CreditKeysType> creditKeys;
     ...
     * This is why there is not a <CODE>set</CODE> method for the creditKeys property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getCreditKeys().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<CreditKeysType> getCreditKeys() {
        if (creditKeys == null) {
            creditKeys = new ArrayList<CreditKeysType>();
        }
        return this.creditKeys;
    }
