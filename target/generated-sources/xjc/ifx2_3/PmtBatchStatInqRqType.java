 ...
 *           &lt;element ref="{IFX2_3}PmtBatchStatSel"/&gt;
...
public class PmtBatchStatInqRqType {
    ...
    @XmlElements({
        @XmlElement(name = "PmtBatchStatSel", type = PmtBatchStatSelType.class),
        @XmlElement(name = "RecSelect", type = String.class)
    })
    protected List<Object> pmtBatchStatSelOrRecSelect;
    ...
    /**
     * Gets the value of the pmtBatchStatSelOrRecSelect property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the pmtBatchStatSelOrRecSelect property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getPmtBatchStatSelOrRecSelect().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link PmtBatchStatSelType }
     * {@link String }
     * 
     * 
     */
    public List<Object> getPmtBatchStatSelOrRecSelect() {
        if (pmtBatchStatSelOrRecSelect == null) {
            pmtBatchStatSelOrRecSelect = new ArrayList<Object>();
        }
        return this.pmtBatchStatSelOrRecSelect;
    }
