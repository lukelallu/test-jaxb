...
/**
 * <p>Java class for DepBkOrdInqRs_Type complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="DepBkOrdInqRs_Type"&gt;
 *   &lt;complexContent&gt;
 ...
 *           &lt;element ref="{IFX2_3}DepBkOrdRec" maxOccurs="unbounded"/&gt;
 *         &lt;/sequence&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
...
@XmlType(name = "DepBkOrdInqRs_Type", propOrder = {
    "status",
    "rqUID",
    "msgRsHdr",
    "docCtrlOut",
...
public class DepBkOrdInqRsType {
    ...
    protected List<DepBkOrdRecType> depBkOrdRec;
     ...
     * This is why there is not a <CODE>set</CODE> method for the depBkOrdRec property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getDepBkOrdRec().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<DepBkOrdRecType> getDepBkOrdRec() {
        if (depBkOrdRec == null) {
            depBkOrdRec = new ArrayList<DepBkOrdRecType>();
        }
        return this.depBkOrdRec;
    }
