 ...
 *           &lt;element ref="{IFX2_3}AcctRec" maxOccurs="unbounded"/&gt;
 *         &lt;/sequence&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
...
public class AcctInqRsType {
    ...
    protected List<AcctRecType> acctRec;
     ...
     * 
     */
    public List<AcctRecType> getAcctRec() {
        if (acctRec == null) {
            acctRec = new ArrayList<AcctRecType>();
        }
        return this.acctRec;
    }
