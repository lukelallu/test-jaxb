...
/**
 * <p>Java class for DiscInqRq_Type complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="DiscInqRq_Type"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "DiscInqRq_Type", propOrder = {
    "rqUID",
    "msgRqHdr",
    "docCtrlIn",
    "recCtrlIn",
...
public class DiscInqRqType {
    ...
    @XmlElements({
        @XmlElement(name = "DiscSel", type = DiscSelType.class),
        @XmlElement(name = "RecSelect", type = String.class)
    })
    protected List<Object> discSelOrRecSelect;
    ...
    /**
     * Gets the value of the discSelOrRecSelect property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the discSelOrRecSelect property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getDiscSelOrRecSelect().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<Object> getDiscSelOrRecSelect() {
        if (discSelOrRecSelect == null) {
            discSelOrRecSelect = new ArrayList<Object>();
        }
        return this.discSelOrRecSelect;
    }
