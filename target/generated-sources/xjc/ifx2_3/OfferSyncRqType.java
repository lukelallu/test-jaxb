...
/**
 * <p>Java class for OfferSyncRq_Type complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="OfferSyncRq_Type"&gt;
 *   &lt;complexContent&gt;
 ...
 *         &lt;element ref="{IFX2_3}OfferKeys" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "OfferSyncRq_Type", propOrder = {
    "rqUID",
    "msgRqHdr",
    "recCtrlIn",
    "offerKeys"
})
public class OfferSyncRqType {
    ...
    @XmlElement(name = "OfferKeys")
    protected List<OfferKeysType> offerKeys;
     ...
     * This is why there is not a <CODE>set</CODE> method for the offerKeys property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getOfferKeys().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<OfferKeysType> getOfferKeys() {
        if (offerKeys == null) {
            offerKeys = new ArrayList<OfferKeysType>();
        }
