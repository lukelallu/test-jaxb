...
/**
 * <p>Java class for RecurXferInqRq_Type complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="RecurXferInqRq_Type"&gt;
 *   &lt;complexContent&gt;
 ...
 *           &lt;element ref="{IFX2_3}RecurXferSel"/&gt;
...
@XmlType(name = "RecurXferInqRq_Type", propOrder = {
    "rqUID",
    "msgRqHdr",
    "docCtrlIn",
    "recCtrlIn",
    "recurXferSelOrRecSelect"
})
public class RecurXferInqRqType {
    ...
    @XmlElements({
        @XmlElement(name = "RecurXferSel", type = RecurXferSelType.class),
        @XmlElement(name = "RecSelect", type = String.class)
    })
    protected List<Object> recurXferSelOrRecSelect;
    ...
    /**
     * Gets the value of the recurXferSelOrRecSelect property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the recurXferSelOrRecSelect property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getRecurXferSelOrRecSelect().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link RecurXferSelType }
     * {@link String }
     * 
     * 
     */
    public List<Object> getRecurXferSelOrRecSelect() {
        if (recurXferSelOrRecSelect == null) {
            recurXferSelOrRecSelect = new ArrayList<Object>();
        }
        return this.recurXferSelOrRecSelect;
    }
