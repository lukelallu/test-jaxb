 ...
 *         &lt;element ref="{IFX2_3}NAICS" minOccurs="0"/&gt;
 *         &lt;element ref="{IFX2_3}SIC" minOccurs="0"/&gt;
 *         &lt;element ref="{IFX2_3}OrgCatIdent" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class OrgCategoryCodeType {
    ...
    @XmlElementRefs({
        @XmlElementRef(name = "NAICS", namespace = "IFX2_3", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "MCC", namespace = "IFX2_3", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "OrgCatIdent", namespace = "IFX2_3", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "SIC", namespace = "IFX2_3", type = JAXBElement.class, required = false)
    })
