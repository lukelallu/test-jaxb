...
public class XferInqRqType {
    ...
    @XmlElements({
        @XmlElement(name = "XferSel", type = XferSelType.class),
        @XmlElement(name = "RecSelect", type = String.class)
    })
    protected List<Object> xferSelOrRecSelect;
    ...
    /**
     * Gets the value of the xferSelOrRecSelect property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the xferSelOrRecSelect property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getXferSelOrRecSelect().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<Object> getXferSelOrRecSelect() {
        if (xferSelOrRecSelect == null) {
            xferSelOrRecSelect = new ArrayList<Object>();
        }
        return this.xferSelOrRecSelect;
    }
