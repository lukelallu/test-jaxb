...
/**
 * <p>Java class for ChkOrdInqRq_Type complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="ChkOrdInqRq_Type"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "ChkOrdInqRq_Type", propOrder = {
    "rqUID",
    "msgRqHdr",
    "docCtrlIn",
    "recCtrlIn",
    "chkOrdSelOrRecSelect"
})
public class ChkOrdInqRqType {
    ...
    @XmlElements({
        @XmlElement(name = "ChkOrdSel", type = ChkOrdSelType.class),
        @XmlElement(name = "RecSelect", type = String.class)
    })
    protected List<Object> chkOrdSelOrRecSelect;
    ...
    /**
     * Gets the value of the chkOrdSelOrRecSelect property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the chkOrdSelOrRecSelect property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getChkOrdSelOrRecSelect().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<Object> getChkOrdSelOrRecSelect() {
        if (chkOrdSelOrRecSelect == null) {
            chkOrdSelOrRecSelect = new ArrayList<Object>();
        }
        return this.chkOrdSelOrRecSelect;
    }
