...
/**
 * <p>Java class for PmtEnclInqRq_Type complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="PmtEnclInqRq_Type"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "PmtEnclInqRq_Type", propOrder = {
    "rqUID",
    "msgRqHdr",
    "docCtrlIn",
    "recCtrlIn",
    "pmtEnclSelOrRecSelect"
})
public class PmtEnclInqRqType {
    ...
    @XmlElements({
        @XmlElement(name = "PmtEnclSel", type = PmtEnclSelType.class),
        @XmlElement(name = "RecSelect", type = String.class)
    })
    protected List<Object> pmtEnclSelOrRecSelect;
    ...
    /**
     * Gets the value of the pmtEnclSelOrRecSelect property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the pmtEnclSelOrRecSelect property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getPmtEnclSelOrRecSelect().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<Object> getPmtEnclSelOrRecSelect() {
        if (pmtEnclSelOrRecSelect == null) {
            pmtEnclSelOrRecSelect = new ArrayList<Object>();
        }
        return this.pmtEnclSelOrRecSelect;
    }
