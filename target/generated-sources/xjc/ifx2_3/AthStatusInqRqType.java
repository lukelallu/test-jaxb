...
/**
 * <p>Java class for AthStatusInqRq_Type complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="AthStatusInqRq_Type"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "AthStatusInqRq_Type", propOrder = {
    "rqUID",
    "msgRqHdr",
    "docCtrlIn",
    "recCtrlIn",
...
public class AthStatusInqRqType {
    ...
    @XmlElements({
        @XmlElement(name = "AthSel", type = AthSelType.class),
        @XmlElement(name = "RecSelect", type = String.class)
    })
    protected List<Object> athSelOrRecSelect;
    ...
    /**
     * Gets the value of the athSelOrRecSelect property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the athSelOrRecSelect property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getAthSelOrRecSelect().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<Object> getAthSelOrRecSelect() {
        if (athSelOrRecSelect == null) {
            athSelOrRecSelect = new ArrayList<Object>();
        }
        return this.athSelOrRecSelect;
    }
