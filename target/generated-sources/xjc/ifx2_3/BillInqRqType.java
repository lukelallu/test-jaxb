...
/**
 * <p>Java class for BillInqRq_Type complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="BillInqRq_Type"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "BillInqRq_Type", propOrder = {
    "rqUID",
    "msgRqHdr",
    "docCtrlIn",
    "recCtrlIn",
...
public class BillInqRqType {
    ...
    @XmlElements({
        @XmlElement(name = "BillSel", type = BillSelType.class),
        @XmlElement(name = "RecSelect", type = String.class)
    })
    protected List<Object> billSelOrRecSelect;
    ...
    /**
     * Gets the value of the billSelOrRecSelect property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the billSelOrRecSelect property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getBillSelOrRecSelect().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<Object> getBillSelOrRecSelect() {
        if (billSelOrRecSelect == null) {
            billSelOrRecSelect = new ArrayList<Object>();
        }
        return this.billSelOrRecSelect;
    }
