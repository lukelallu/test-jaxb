...
/**
 * <p>Java class for StopChkInqRq_Type complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="StopChkInqRq_Type"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "StopChkInqRq_Type", propOrder = {
    "rqUID",
    "msgRqHdr",
    "docCtrlIn",
    "recCtrlIn",
    "stopChkSelOrRecSelect"
})
public class StopChkInqRqType {
    ...
    @XmlElements({
        @XmlElement(name = "StopChkSel", type = StopChkSelType.class),
        @XmlElement(name = "RecSelect", type = String.class)
    })
    protected List<Object> stopChkSelOrRecSelect;
    ...
    /**
     * Gets the value of the stopChkSelOrRecSelect property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the stopChkSelOrRecSelect property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getStopChkSelOrRecSelect().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<Object> getStopChkSelOrRecSelect() {
        if (stopChkSelOrRecSelect == null) {
            stopChkSelOrRecSelect = new ArrayList<Object>();
        }
        return this.stopChkSelOrRecSelect;
    }
