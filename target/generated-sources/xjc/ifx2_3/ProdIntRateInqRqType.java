...
/**
 * <p>Java class for ProdIntRateInqRq_Type complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="ProdIntRateInqRq_Type"&gt;
 *   &lt;complexContent&gt;
 ...
 *           &lt;element ref="{IFX2_3}ProdIntRateSel"/&gt;
...
@XmlType(name = "ProdIntRateInqRq_Type", propOrder = {
    "rqUID",
    "msgRqHdr",
    "docCtrlIn",
    "recCtrlIn",
    "prodIntRateSelOrRecSelect"
})
public class ProdIntRateInqRqType {
    ...
    @XmlElements({
        @XmlElement(name = "ProdIntRateSel", type = ProdIntRateSelType.class),
        @XmlElement(name = "RecSelect", type = String.class)
    })
    protected List<Object> prodIntRateSelOrRecSelect;
    ...
    /**
     * Gets the value of the prodIntRateSelOrRecSelect property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the prodIntRateSelOrRecSelect property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getProdIntRateSelOrRecSelect().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link ProdIntRateSelType }
     * {@link String }
     * 
     * 
     */
    public List<Object> getProdIntRateSelOrRecSelect() {
        if (prodIntRateSelOrRecSelect == null) {
            prodIntRateSelOrRecSelect = new ArrayList<Object>();
        }
        return this.prodIntRateSelOrRecSelect;
    }
