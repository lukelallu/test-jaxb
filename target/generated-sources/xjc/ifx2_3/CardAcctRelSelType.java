...
public class CardAcctRelSelType {
    ...
    protected List<BaseKeysType> cardAcctRelKeysOrCardKeysAndAcctKeys;
     ...
     * 
     */
    public List<BaseKeysType> getCardAcctRelKeysOrCardKeysAndAcctKeys() {
        if (cardAcctRelKeysOrCardKeysAndAcctKeys == null) {
            cardAcctRelKeysOrCardKeysAndAcctKeys = new ArrayList<BaseKeysType>();
        }
