...
/**
 * <p>Java class for AthSyncRs_Type complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="AthSyncRs_Type"&gt;
 *   &lt;complexContent&gt;
 ...
 *           &lt;element ref="{IFX2_3}AthRsMsg" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;/sequence&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
...
@XmlType(name = "AthSyncRs_Type", propOrder = {
    "status",
    "rqUID",
    "msgRsHdr",
    "recCtrlOut",
...
public class AthSyncRsType {
    ...
    @XmlElement(name = "AthRsMsg")
    protected List<AthRsMsgType> athRsMsg;
    ...
    /**
     * Gets the value of the athRsMsg property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the athRsMsg property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getAthRsMsg().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<AthRsMsgType> getAthRsMsg() {
        if (athRsMsg == null) {
            athRsMsg = new ArrayList<AthRsMsgType>();
        }
        return this.athRsMsg;
    }
