...
/**
 * <p>Java class for AthSyncRq_Type complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="AthSyncRq_Type"&gt;
 *   &lt;complexContent&gt;
 ...
 *         &lt;element ref="{IFX2_3}AthKeys" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "AthSyncRq_Type", propOrder = {
    "rqUID",
    "msgRqHdr",
    "recCtrlIn",
    "athKeys"
})
public class AthSyncRqType {
    ...
    protected List<AthKeysType> athKeys;
     ...
     * This is why there is not a <CODE>set</CODE> method for the athKeys property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getAthKeys().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<AthKeysType> getAthKeys() {
        if (athKeys == null) {
            athKeys = new ArrayList<AthKeysType>();
        }
        return this.athKeys;
    }
