...
/**
 * <p>Java class for PmtSyncRs_Type complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="PmtSyncRs_Type"&gt;
 *   &lt;complexContent&gt;
 ...
 *           &lt;element ref="{IFX2_3}PmtRsMsg" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;/sequence&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
...
@XmlType(name = "PmtSyncRs_Type", propOrder = {
    "status",
    "rqUID",
    "msgRsHdr",
    "recCtrlOut",
...
public class PmtSyncRsType {
    ...
    @XmlElement(name = "PmtRsMsg")
    protected List<PmtRsMsgType> pmtRsMsg;
    ...
    /**
     * Gets the value of the pmtRsMsg property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the pmtRsMsg property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getPmtRsMsg().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<PmtRsMsgType> getPmtRsMsg() {
        if (pmtRsMsg == null) {
            pmtRsMsg = new ArrayList<PmtRsMsgType>();
        }
        return this.pmtRsMsg;
    }
