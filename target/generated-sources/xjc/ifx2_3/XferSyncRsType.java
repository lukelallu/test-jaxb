...
/**
 * <p>Java class for XferSyncRs_Type complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="XferSyncRs_Type"&gt;
 *   &lt;complexContent&gt;
 ...
 *           &lt;element ref="{IFX2_3}XferRsMsg" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;/sequence&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
...
@XmlType(name = "XferSyncRs_Type", propOrder = {
    "status",
    "rqUID",
    "msgRsHdr",
    "recCtrlOut",
...
public class XferSyncRsType {
    ...
    @XmlElement(name = "XferRsMsg")
    protected List<XferRsMsgType> xferRsMsg;
    ...
    /**
     * Gets the value of the xferRsMsg property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the xferRsMsg property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getXferRsMsg().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<XferRsMsgType> getXferRsMsg() {
        if (xferRsMsg == null) {
            xferRsMsg = new ArrayList<XferRsMsgType>();
        }
        return this.xferRsMsg;
    }
