...
/**
 * <p>Java class for NoteInqRq_Type complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="NoteInqRq_Type"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "NoteInqRq_Type", propOrder = {
    "rqUID",
    "msgRqHdr",
    "docCtrlIn",
    "recCtrlIn",
...
public class NoteInqRqType {
    ...
    @XmlElements({
        @XmlElement(name = "NoteSel", type = NoteSelType.class),
        @XmlElement(name = "RecSelect", type = String.class)
    })
    protected List<Object> noteSelOrRecSelect;
    ...
    /**
     * Gets the value of the noteSelOrRecSelect property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the noteSelOrRecSelect property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getNoteSelOrRecSelect().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<Object> getNoteSelOrRecSelect() {
        if (noteSelOrRecSelect == null) {
            noteSelOrRecSelect = new ArrayList<Object>();
        }
        return this.noteSelOrRecSelect;
    }
