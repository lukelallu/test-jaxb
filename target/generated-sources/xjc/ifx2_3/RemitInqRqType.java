...
/**
 * <p>Java class for RemitInqRq_Type complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="RemitInqRq_Type"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "RemitInqRq_Type", propOrder = {
    "rqUID",
    "msgRqHdr",
    "docCtrlIn",
    "recCtrlIn",
...
public class RemitInqRqType {
    ...
    @XmlElements({
        @XmlElement(name = "RemitSel", type = RemitSelType.class),
        @XmlElement(name = "RecSelect", type = String.class)
    })
    protected List<Object> remitSelOrRecSelect;
    ...
    /**
     * Gets the value of the remitSelOrRecSelect property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the remitSelOrRecSelect property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getRemitSelOrRecSelect().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<Object> getRemitSelOrRecSelect() {
        if (remitSelOrRecSelect == null) {
            remitSelOrRecSelect = new ArrayList<Object>();
        }
        return this.remitSelOrRecSelect;
    }
