...
/**
 * <p>Java class for BillerInqRq_Type complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="BillerInqRq_Type"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "BillerInqRq_Type", propOrder = {
    "rqUID",
    "msgRqHdr",
    "docCtrlIn",
    "recCtrlIn",
    "billerSelOrRecSelect"
})
public class BillerInqRqType {
    ...
    @XmlElements({
        @XmlElement(name = "BillerSel", type = BillerSelType.class),
        @XmlElement(name = "RecSelect", type = String.class)
    })
    protected List<Object> billerSelOrRecSelect;
    ...
    /**
     * Gets the value of the billerSelOrRecSelect property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the billerSelOrRecSelect property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getBillerSelOrRecSelect().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<Object> getBillerSelOrRecSelect() {
        if (billerSelOrRecSelect == null) {
            billerSelOrRecSelect = new ArrayList<Object>();
        }
        return this.billerSelOrRecSelect;
    }
