...
/**
 * <p>Java class for ChksumSyncRq_Type complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="ChksumSyncRq_Type"&gt;
 *   &lt;complexContent&gt;
 ...
 *         &lt;element ref="{IFX2_3}ChksumKeys" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "ChksumSyncRq_Type", propOrder = {
    "rqUID",
    "msgRqHdr",
    "recCtrlIn",
    "chksumKeys"
})
public class ChksumSyncRqType {
    ...
    protected List<ChksumKeysType> chksumKeys;
     ...
     * This is why there is not a <CODE>set</CODE> method for the chksumKeys property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getChksumKeys().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<ChksumKeysType> getChksumKeys() {
        if (chksumKeys == null) {
            chksumKeys = new ArrayList<ChksumKeysType>();
        }
        return this.chksumKeys;
    }
