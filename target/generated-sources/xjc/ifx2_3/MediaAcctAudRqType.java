...
/**
 * <p>Java class for MediaAcctAudRq_Type complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="MediaAcctAudRq_Type"&gt;
 *   &lt;complexContent&gt;
 ...
 *         &lt;element ref="{IFX2_3}MediaAcctKeys" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "MediaAcctAudRq_Type", propOrder = {
    "rqUID",
    "msgRqHdr",
    "recCtrlIn",
    "dtRange",
...
public class MediaAcctAudRqType {
    ...
    protected List<MediaAcctKeysType> mediaAcctKeys;
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the mediaAcctKeys property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getMediaAcctKeys().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<MediaAcctKeysType> getMediaAcctKeys() {
        if (mediaAcctKeys == null) {
            mediaAcctKeys = new ArrayList<MediaAcctKeysType>();
        }
        return this.mediaAcctKeys;
    }
