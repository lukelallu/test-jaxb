...
/**
 * <p>Java class for RecurChkOrdInqRq_Type complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="RecurChkOrdInqRq_Type"&gt;
 *   &lt;complexContent&gt;
 ...
 *           &lt;element ref="{IFX2_3}RecurChkOrdSel"/&gt;
...
@XmlType(name = "RecurChkOrdInqRq_Type", propOrder = {
    "rqUID",
    "msgRqHdr",
    "docCtrlIn",
    "recCtrlIn",
    "recurChkOrdSelOrRecSelect"
})
public class RecurChkOrdInqRqType {
    ...
    @XmlElements({
        @XmlElement(name = "RecurChkOrdSel", type = RecurChkOrdSelType.class),
        @XmlElement(name = "RecSelect", type = String.class)
    })
    protected List<Object> recurChkOrdSelOrRecSelect;
    ...
    /**
     * Gets the value of the recurChkOrdSelOrRecSelect property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the recurChkOrdSelOrRecSelect property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getRecurChkOrdSelOrRecSelect().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link RecurChkOrdSelType }
     * {@link String }
     * 
     * 
     */
    public List<Object> getRecurChkOrdSelOrRecSelect() {
        if (recurChkOrdSelOrRecSelect == null) {
            recurChkOrdSelOrRecSelect = new ArrayList<Object>();
        }
        return this.recurChkOrdSelOrRecSelect;
    }
