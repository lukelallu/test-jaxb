...
/**
 * <p>Java class for DevInqRq_Type complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="DevInqRq_Type"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "DevInqRq_Type", propOrder = {
    "rqUID",
    "msgRqHdr",
    "docCtrlIn",
    "recCtrlIn",
...
public class DevInqRqType {
    ...
    @XmlElements({
        @XmlElement(name = "DevSel", type = DevSelType.class),
        @XmlElement(name = "RecSelect", type = String.class)
    })
    protected List<Object> devSelOrRecSelect;
    ...
    /**
     * Gets the value of the devSelOrRecSelect property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the devSelOrRecSelect property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getDevSelOrRecSelect().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<Object> getDevSelOrRecSelect() {
        if (devSelOrRecSelect == null) {
            devSelOrRecSelect = new ArrayList<Object>();
        }
        return this.devSelOrRecSelect;
    }
