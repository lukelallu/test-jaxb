...
/**
 * <p>Java class for PmtSyncRq_Type complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="PmtSyncRq_Type"&gt;
 *   &lt;complexContent&gt;
 ...
 *         &lt;element ref="{IFX2_3}PmtKeys" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "PmtSyncRq_Type", propOrder = {
    "rqUID",
    "msgRqHdr",
    "recCtrlIn",
    "pmtKeys"
})
public class PmtSyncRqType {
    ...
    protected List<PmtKeysType> pmtKeys;
     ...
     * This is why there is not a <CODE>set</CODE> method for the pmtKeys property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getPmtKeys().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<PmtKeysType> getPmtKeys() {
        if (pmtKeys == null) {
            pmtKeys = new ArrayList<PmtKeysType>();
        }
        return this.pmtKeys;
    }
