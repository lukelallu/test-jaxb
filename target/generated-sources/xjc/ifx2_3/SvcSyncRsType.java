...
/**
 * <p>Java class for SvcSyncRs_Type complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="SvcSyncRs_Type"&gt;
 *   &lt;complexContent&gt;
 ...
 *           &lt;element ref="{IFX2_3}SvcRsMsg" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;/sequence&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
...
@XmlType(name = "SvcSyncRs_Type", propOrder = {
    "status",
    "rqUID",
    "msgRsHdr",
    "recCtrlOut",
...
public class SvcSyncRsType {
    ...
    @XmlElement(name = "SvcRsMsg")
    protected List<SvcRsMsgType> svcRsMsg;
    ...
    /**
     * Gets the value of the svcRsMsg property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the svcRsMsg property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getSvcRsMsg().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<SvcRsMsgType> getSvcRsMsg() {
        if (svcRsMsg == null) {
            svcRsMsg = new ArrayList<SvcRsMsgType>();
        }
        return this.svcRsMsg;
    }
