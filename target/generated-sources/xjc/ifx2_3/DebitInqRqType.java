...
/**
 * <p>Java class for DebitInqRq_Type complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="DebitInqRq_Type"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "DebitInqRq_Type", propOrder = {
    "rqUID",
    "msgRqHdr",
    "docCtrlIn",
    "recCtrlIn",
...
public class DebitInqRqType {
    ...
    @XmlElements({
        @XmlElement(name = "DebitSel", type = DebitSelType.class),
        @XmlElement(name = "RecSelect", type = String.class)
    })
    protected List<Object> debitSelOrRecSelect;
    ...
    /**
     * Gets the value of the debitSelOrRecSelect property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the debitSelOrRecSelect property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getDebitSelOrRecSelect().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<Object> getDebitSelOrRecSelect() {
        if (debitSelOrRecSelect == null) {
            debitSelOrRecSelect = new ArrayList<Object>();
        }
        return this.debitSelOrRecSelect;
    }
