...
import ifx2_3.DocCtrlInType;
import ifx2_3.MsgRqHdrType;
import ifx2_3.RecCtrlInType;
 ...
 *           &lt;element ref="{http://www.mtb.com/canonical/schema/mtb/1_0/PartyAcctRelation}PartyAcctRelSel"/&gt;
...
public class PartyAcctRelInqRqType {
    ...
    @XmlElement(name = "DocCtrlIn", namespace = "IFX2_3")
    protected DocCtrlInType docCtrlIn;
    @XmlElement(name = "RecCtrlIn", namespace = "IFX2_3")
    protected RecCtrlInType recCtrlIn;
    @XmlElements({
        @XmlElement(name = "PartyAcctRelSel", type = PartyAcctRelSelType.class),
        @XmlElement(name = "RecSelect", namespace = "IFX2_3", type = String.class)
    })
