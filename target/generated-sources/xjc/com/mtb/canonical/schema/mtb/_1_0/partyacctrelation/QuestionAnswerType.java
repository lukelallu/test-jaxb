...
public class QuestionAnswerType {
    ...
    @XmlElement(name = "QuestionIdent", namespace = "IFX2_3")
    protected String questionIdent;
    @XmlElement(name = "Question", namespace = "IFX2_3")
    protected String question;
    @XmlElement(name = "Selection", namespace = "IFX2_3")
    protected String selection;
    @XmlElement(name = "Answer", namespace = "IFX2_3")
