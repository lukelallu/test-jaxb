 ...
 *       &lt;choice&gt;
 *         &lt;element name="USCHU" type="{urn:swift:xsd:pain.001.001.01}CHIPSUniversalIdentifier"/&gt;
 *         &lt;element name="NZNCC" type="{urn:swift:xsd:pain.001.001.01}NewZealandNCCIdentifier"/&gt;
 *         &lt;element name="IENSC" type="{urn:swift:xsd:pain.001.001.01}IrishNSCIdentifier"/&gt;
 *         &lt;element name="GBSC" type="{urn:swift:xsd:pain.001.001.01}UKDomesticSortCodeIdentifier"/&gt;
 *         &lt;element name="USCH" type="{urn:swift:xsd:pain.001.001.01}CHIPSParticipantIdentifier"/&gt;
 *         &lt;element name="CHBC" type="{urn:swift:xsd:pain.001.001.01}SwissBCIdentifier"/&gt;
 *         &lt;element name="USFW" type="{urn:swift:xsd:pain.001.001.01}FedwireRoutingNumberIdentifier"/&gt;
 *         &lt;element name="PTNCC" type="{urn:swift:xsd:pain.001.001.01}PortugueseNCCIdentifier"/&gt;
 *         &lt;element name="RUCB" type="{urn:swift:xsd:pain.001.001.01}RussianCentralBankIdentificationCodeIdentifier"/&gt;
 *         &lt;element name="ITNCC" type="{urn:swift:xsd:pain.001.001.01}ItalianDomesticIdentifier"/&gt;
 *         &lt;element name="ATBLZ" type="{urn:swift:xsd:pain.001.001.01}AustrianBankleitzahlIdentifier"/&gt;
 *         &lt;element name="CACPA" type="{urn:swift:xsd:pain.001.001.01}CanadianPaymentsARNIdentifier"/&gt;
 *         &lt;element name="CHSIC" type="{urn:swift:xsd:pain.001.001.01}SwissSICIdentifier"/&gt;
 *         &lt;element name="DEBLZ" type="{urn:swift:xsd:pain.001.001.01}GermanBankleitzahlIdentifier"/&gt;
 *         &lt;element name="ESNCC" type="{urn:swift:xsd:pain.001.001.01}SpanishDomesticInterbankingIdentifier"/&gt;
 *         &lt;element name="ZANCC" type="{urn:swift:xsd:pain.001.001.01}SouthAfricanNCCIdentifier"/&gt;
 *         &lt;element name="HKNCC" type="{urn:swift:xsd:pain.001.001.01}HongKongBankIdentifier"/&gt;
 *         &lt;element name="AUBSBx" type="{urn:swift:xsd:pain.001.001.01}ExtensiveBranchNetworkIdentifier"/&gt;
 *         &lt;element name="AUBSBs" type="{urn:swift:xsd:pain.001.001.01}SmallNetworkIdentifier"/&gt;
 *       &lt;/choice&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
